...
import com.ccs3402.lab.smartcampusnavigationsystem.Service.Facilities;
...
public class Main extends Application {
    ...
    private Graph busGraph = new Graph();
    ...
    public void start(Stage stage) {
        ...
        facilityBtn.setOnAction(e -> {
            ...
            double travelTime = bestDistance / 70.0; // walking speed
            ...
            sb.append("⏱ Estimated Time: ")
                    .append(String.format("%.2f", travelTime))
                    .append(" min\n");
        ...
        findBtn.setOnAction(e -> {
            ...
            sb.append("\nEstimated Walking Time: ")
                    .append(String.format("%.2f", walkTime))
                    .append(" minutes");
            ...
            if (busRoute.getPath().isEmpty() || !busAvailable) {
                ...
                sb.append("\n🚌 Travel time: ")
                        .append(String.format("%.2f", busTravelTime))
                        .append(" min");
                ...
                sb.append("\n⏱ Total time: ")
                        .append(String.format("%.2f", totalBusTime))
                        .append(" min");
    ...
    private void buildGraph() {
        ...
        graph.addEdge("FSKTM", "Guard House KC",200);
